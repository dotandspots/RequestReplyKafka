...
//	  
//	  @Bean
//	    public SyncToAsyncTemplate<String,String> getCustomerServiceInvoker(){
//	        SyncToAsyncTemplate<String,String> customerServiceInvoker=
//	                new SyncToAsyncTemplate<String,String>("CustomerService", "getAll");
